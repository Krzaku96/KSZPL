...
class ShowRecipeComponent extends Component{
    ...
    componentDidMount(){
        axios.get( BASE_URL + `/recipe/getrecipe/${this.props.match.params.id}`)
            .then((response) => {
                debugger;
                this.setState({
                    id: response.data.id,
            ...
            <Card>
                ...
                <Row>
                    <Form horizontal className="formVisit">
                        <Col sm={12}> 
                            <Form.Label className="labelVisit"> <b>  Informacje o recepcie </b> </Form.Label>
                        </Col>
                        <Row>
                            <Col sm={5}> <Form.Label> <b> Termin realizacji:</b>  </Form.Label> </Col>
                            <Col sm={7}> <Form.Label> {this.parseDate(this.state.dateRelease)} </Form.Label> </Col>
                        </Row>
                        <Row>
                            <Col sm={5}> <Form.Label><b> Doktor wystawiający:</b> </Form.Label> </Col>
                            <Col sm={7}> <Form.Label> {this.state.doctorName} </Form.Label> </Col>
                        </Row>
                        <Row>
                            <Col sm={5}> <Form.Label> <b>Przepisane leki:</b> </Form.Label> </Col>
                            <Col sm={7}> <Form.Label> {this.state.prescribedMedicines} </Form.Label> </Col>
                        </Row>
                        <Row>
