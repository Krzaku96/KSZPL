...
class ShowVisitComponent extends Component {
  ...
  componentDidMount() {
    axios
      .get(BASE_URL + `visit/getvisit/${this.props.match.params.id}`)
      .then(response => {
        debugger;
        this.setState({
          ...
          <Row>
            <Form horizontal className="formVisit">
              ...
              <Row>
                ...
                <Col sm={7}>
                  {" "}
                  <Form.Label> {this.state.patientName} </Form.Label>{" "}
                </Col>
              </Row>
              <Row>
                <Col sm={5}>
                ...
                <Col sm={7}>
                  {" "}
                  <Form.Label> {this.state.place} </Form.Label>{" "}
                </Col>
              </Row>
              <Row>
                <Col sm={5}>
              ...
              <Row>
                ...
                <Col sm={4}>
                  {" "}
                  <Button
                    onClick={() => this.OnClickRecipe(this.state.id)}
